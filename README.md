...
- Bản đồ hiển thị ngay theo các quán đã lưu; định vị kiểm tra cache của thiết bị trong khoảng 200 ms trước, sau đó mới lấy vị trí mạng/GPS tối đa khoảng 2,2 giây. Vị trí gần đây được lưu cục bộ tối đa 30 phút; nút “Định vị tôi” cho phép thử lại.
